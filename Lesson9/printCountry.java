...
public class LargestTester
{
    public static void main(String[] args)
    {
        ...
        Measurable largestCountry = Data.largest(centralAmericanCountries);
        Country largestCountry0 = (Country) largestCountry;
        System.out.println("Largest country: " + largestCountry0.getName());
