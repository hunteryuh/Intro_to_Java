...
public class TrueFalseQuestion extends Question
{
   ...
   // TODO: for the final, override the necessay  method(s) all valid answers as specified
    ...
    public void setAnswer(String correctAnswer){
        super.setAnswer(correctAnswer.toLowerCase());
    }
    public boolean checkAnswer(String response)
    {
        if (response.toLowerCase().equals("t") || response.toLowerCase().equals("true") ){
        return super.checkAnswer("true");
    } else if (response.toLowerCase().equals("f") || response.toLowerCase().equals("false")){
